...
class WC_Email_Photography_New_Collection extends WC_Email {
	...
	public function __construct() {
		...
		$this->id             = 'WC_Printfolio_new_collection';
		$this->title          = __( 'New Photography Collection', 'printfolio' );
		$this->description    = __( 'This email is sent to customers when you assign a collection to their account.', 'printfolio' );
		...
		$this->template_base = WC_Printfolio::get_templates_path();
	}
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled' => array(
				'title'   => __( 'Enable/Disable', 'printfolio' ),
				'type'    => 'checkbox',
				'label'   => __( 'Enable this email notification', 'printfolio' ),
				'default' => 'yes'
			),
			'subject' => array(
				'title'       => __( 'Subject', 'printfolio' ),
				'type'        => 'text',
				'description' => sprintf( __( 'This controls the email subject line. Leave blank to use the default subject: <code>%s</code>.', 'printfolio' ), $this->subject ),
				'placeholder' => '',
				'default'     => ''
			),
			'heading' => array(
				'title'       => __( 'Email Heading', 'printfolio' ),
				'type'        => 'text',
				'description' => sprintf( __( 'This controls the main heading contained within the email. Leave blank to use the default heading: <code>%s</code>.', 'printfolio' ), $this->heading ),
				'placeholder' => '',
				'default'     => ''
			),
			'email_type' => array(
				'title'       => __( 'Email type', 'printfolio' ),
				'type'        => 'select',
				'description' => __( 'Choose which format of email to send.', 'printfolio' ),
				'default'     => 'html',
				'class'       => 'email_type',
				'options'     => array(
					'plain'     => __( 'Plain text', 'printfolio' ),
					'html'      => __( 'HTML', 'printfolio' ),
					'multipart' => __( 'Multipart', 'printfolio' ),
				)
			)
		);
	}
